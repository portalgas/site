...
if($userJoomla->organization['Organization']['id']==1)
	$organization_name = 'Gas La Cavagnetta';
else
if($userJoomla->organization['Organization']['id']==2)
	$organization_name = 'Gas Avigliana';
