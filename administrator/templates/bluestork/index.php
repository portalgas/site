...
?>
	...
	if(browser_version==-1) {
		...
		document.write('<script type=\"text/javascript\" src=\"<?php echo $this->baseurl ?>/../components/com_cake/app/webroot/js/genericBackOffice-v07.min.js?v=20231025\"><\/script>');		
	}
	else {
