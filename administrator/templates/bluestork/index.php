...
?>
	...
	if(browser_version==-1) {
		...
		document.write('<script type=\"text/javascript\" src=\"<?php echo $this->baseurl ?>/../components/com_cake/app/webroot/js/genericBackOffice-v09.min.js?v=20260318\"><\/script>');
	}
	else {
