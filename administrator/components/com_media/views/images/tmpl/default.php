...
if(isset($user->organization['Organization']['id'])) {
	...
	// $acl_path ='/organizations/'.$user->organization['Organization']['j_seo'];
	$acl_path ='/organizations/'.$user->organization['Organization']['id'];
}
else
	$acl_path = '';
...
echo $params->get('image_path', 'images');?><?php echo $acl_path;?>/';
</script>
