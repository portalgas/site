...
class JFormFieldAttendee extends JFormField
{
	...
	protected function getInput ()
	{
		...
		$link = 'index.php?option=com_dpcalendar&amp;view=attendees&amp;layout=modal&amp;tmpl=component&amp;field=' . $this->id .
		...
		// Load the current Attendee if available.
		$table = JTable::getInstance('Attendee', 'DPCalendarTable');
		...
		// Create a dummy text field with the attendee name.
		...
		// Create the real field, hidden, that stored the attendee id.
