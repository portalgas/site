...
$document->addStyleDeclaration('#jform_scheduling_weekly_days,
		#jform_scheduling_monthly_days,
		#jform_scheduling_monthly_week,
		 #jform_scheduling_monthly_week_days {max-width:330px}');
$document->addStyleDeclaration('#jform_scheduling_monthly_days li,
		#jform_scheduling_monthly_week li{float:left; margin-right:10px; list-style-type:none}');
$document->addStyleDeclaration('#jform_scheduling_monthly_week_days li{float:left; margin-right:10px; list-style-type:none}
		#jform_scheduling_monthly_week_days label, #jform_scheduling_monthly_week_days input{float:left; margin-right:10px}');
$document->addStyleDeclaration('#jform_scheduling_weekly_days li{float:left; margin-right:10px; list-style-type:none}
		#jform_scheduling_weekly_days label, #jform_scheduling_weekly_days input{float:left; margin-right:10px}');
?>
