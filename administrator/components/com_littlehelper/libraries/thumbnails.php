...
class gimmeImage
{
	public static function getImageInfo($imagePath,$image) {
		...
		if (preg_match("/\.jpg|\.jpeg/",$image)){$src_img=imagecreatefromjpeg($originalImageFilename);}
		elseif (preg_match("/\.gif/", $image)){$src_img=imagecreatefromgif($originalImageFilename);}
		elseif (preg_match("/\.png/", $image)){$src_img=imagecreatefrompng($originalImageFilename);}
		else
			return NULL;
		if (!$src_img) {
...
/*
	 ...
	 */
	public static function createThumb($originalImageFilename,$filename,$new_w,$new_h,$dest_extension='png')
	{
		...
		if (preg_match("/jpg|jpeg/",$source_extension)){$src_img=imagecreatefromjpeg($originalImageFilename);}
		elseif (preg_match("/gif/", $source_extension)){$src_img=imagecreatefromgif($originalImageFilename);}
		elseif (preg_match("/png/", $source_extension)){$src_img=imagecreatefrompng($originalImageFilename);}
		else
		return NULL;
