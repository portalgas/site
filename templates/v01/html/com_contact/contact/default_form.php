    ...
    <div class="container">
        ...
        ?>
              ...
              ?>            
                ...
                <p>
                  <select name="jform[contact_organization_id]" id="jform_contact_organization_id" class="form-control selectpicker-disabled" data-validation-required-message="Indica a quale GAS appartieni">
