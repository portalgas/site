...
$(document).ready(function() {
	...
	$('.userUpdateNoDES').click(function() {

		if($(this).hasClass('stato_1')) {
			$(this).removeClass('stato_1');
			$(this).addClass('stato_0');
		}
		else {
			$(this).removeClass('stato_0');
			$(this).addClass('stato_1');
		}

		var user_id = $(this).data('attr-user-id');
		var field = $(this).data('attr-field');
		var url = "/administrator/index.php?option=com_cake&controller=Users&action=inverseValueNoDes&user_id="+user_id+"&field="+field+"&format=notmpl";
		/* console.log(url); */
