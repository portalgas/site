...
?>
	...
	foreach ($results as $numResult => $result) {
		...
		echo '<a class="action actionList" 
				 ...
				 target="_blank" 
				 href="/administrator/index.php?option=com_cake&controller=Connects&action=index&c_to=admin/articles&a_to=index-quick&q=search_supplier_organization_id='.$result['SuppliersOrganization']['id'].'">
			</a>';
