...
?>
<h3>Attenzione: se modifichi la quantità</h3>
...
<div class="sp-slideshow">
		...
		<table style="float:left;">
			<tr>
				<td style="width:32px;padding:0 15px;">
					<img src="/images/cake/apps/32x32/kexi_split.png" />
				</td>
				<td>degli acquisti dividendo le <b>quantità</b> di ogni acquisto</td>
			</tr>
		</table>					

		<img style="width:425px;float:right;" class="imgPrintScreen" alt="tab della gestione dell'ordine" src="<?php echo Configure::read('App.img.cake'); ;?>/info_ordine_gestisci_acquisti_suddivisi.jpg" />
		
	</li>
	
	<li>
		Se ora, con la gestione <img src="/images/cake/apps/32x32/kexi_one.png" /> degli acquisti dell'ordine nel <b>dettaglio</b> 
		<br />farai qualche modifica sul carrello di un gasista dovrai <b>ricalcolare</b> gli importi divisi per la quantità di ogni acquisto
			<br />
			<br />
			...
			<div class="cakeContainer">		
				<ul class="menuLateraleItems">
					<li><span class="popupNum">1</span> vai su "Gestisci gli acquisti dividendo le <b>quantità</b> di ogni acquisto"</li>
					<li><span class="popupNum">2</span> Scegli "Rigenero i dati sottostanti perché ho modificato gli acquisti degli utenti"</li>
				</ul>
			</div>
			<img style="float:right;" class="imgPrintScreen" alt="rigenera i dati suddivisi per quantità" src="<?php echo Configure::read('App.img.cake'); ;?>/info_acquisti_divisi_ricarica.jpg" />
	...
	<li>
		...
		<div class="cakeContainer">		
			...
			-->
			<li><span class="popupNum">2</span> <span class="popupVoceMenu bgLeft actionEditDbSplit">Gestisci gli acquisti dividendo le quantità</span></li>
			<!--
