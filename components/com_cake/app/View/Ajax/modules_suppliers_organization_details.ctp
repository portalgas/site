 ...
 if (!empty($results)):?>	
	...
	<ul class="list">
		...
		<li><?php 
			...
			if(!empty($results['Supplier']['slug'])) echo '<a title="pagina portalgas del produttore" href="'.Configure::read('Neo.portalgas.url').'site/produttore/'.$results['Supplier']['slug'].'" class="blank fa fa-globe fa-lg"></a>';
			?>
		</li>
	</ul>
