...
if(!empty($results)) {
	...
	echo $this->Html->link(null, array('controller' => 'Docs','action' => 'prodGasSupplierDocsExport', null, 'organization_id='.$result['Order']['organization_id'].'&delivery_id='.$result['Order']['delivery_id'].'&order_id='.$result['Order']['id']), array('class' => 'action actionPrinter','title' => __('Print Order')));
	echo '</td>';
	...
	echo '	<td colspan="4" id="tdViewId-'.$result['Order']['id'].'"></td>';
	echo '</tr>';
