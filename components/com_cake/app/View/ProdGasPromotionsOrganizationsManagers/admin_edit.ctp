...
echo '<div id="tabs-0">';
	...
	echo $this->Form->input('data_inizio',array('type' => 'text','size'=>'30','label' => __('Data inizio'), 'value' => $this->Time->i18nFormat($this->Form->value('Order.data_inizio')), 'required'=>'false'));
	...
	echo '<input type="hidden" id="ProdGasPromotionsOrganizationsManagerDataInizioDb" name="data[ProdGasPromotionsOrganizationsManager][data_inizio_db]" value="'.$this->Form->value('Order.data_inizio').'" />';
	...
	if(!empty($this->request->data['Order']['data_fine_validation']) && $this->request->data['Order']['data_fine_validation']!=Configure::read('DB.field.date.empty')) {
		...
		echo $this->Form->input('data_fine',array('type' => 'text','size'=>'30','label' => __('Data fine'), 'value' => $this->Time->i18nFormat($this->Form->value('Order.data_fine')), 'required'=>'false'));
		...
		echo '<input type="hidden" id="ProdGasPromotionsOrganizationsManagerDataFineDb" name="data[ProdGasPromotionsOrganizationsManager][data_fine_db]" value="'.$this->Form->value('Order.data_fine').'" />';
	}	
