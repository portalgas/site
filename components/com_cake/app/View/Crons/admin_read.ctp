...
$this->Html->addCrumb(__('Cron'), array('controller' => 'Crons', 'action' => 'index'));
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Cron'), array('action' => 'index'),array('class'=>'action actionReload'));?></li>
	</ul>
</div>