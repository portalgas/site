...
<?php echo $this->Form->create('Supplier', array('type' => 'post'));?>
	<fieldset>
		...
		<div class="input text"><label class="big" for="">Totale produttori associati alle organizzazioni</label><span class="<?php echo $class;?>"><?php echo count($results['SuppliersOrganization']);?></span></div>
