...
<div class="table">
	...
	<tr>
		...
		<td><a class="exportDelivery" id="userCart-PDF" style="cursor:pointer;" rel="nofollow" title="stampa gli acqusiti alla consegna <?php echo __('formatFilePdf');?>"><i class="fa fa-file-pdf-o fa-2x"></i></a></td>
		<td></td>
		<td></td>
	</tr>
	<tr>
		...
		<td><a class="exportDelivery" id="usersDelivery-PDF" style="cursor:pointer;" rel="nofollow" title="stampa gli utenti che saranno presenti alla consegna <?php echo __('formatFilePdf');?>"><i class="fa fa-file-pdf-o fa-2x"></i></a></td>
		<td><a class="exportDelivery" id="usersDelivery-CSV" style="cursor:pointer;" rel="nofollow" title="stampa gli utenti che saranno presenti alla consegna <?php echo __('formatFileCsv');?>"><i class="fa fa-file-text-o fa-2x"></i></a></td>
		<td>
			<?php
			if(Configure::read('developer.mode'))
				echo 'No in developer mode';
			else
				echo '<a class="exportDelivery" id="usersDelivery-EXCEL" style="cursor:pointer;" rel="nofollow" title="stampa gli utenti che saranno presenti alla consegna '.__('formatFileExcel').'"><i class="fa fa-file-excel-o fa-2x"></i></a>';
			?>
		</td>
	</tr>
	<tr>
		...
		<td><a class="exportArticles" id="articlesSupplierOrganization-PDF" style="cursor:pointer;" rel="nofollow" title="stampa gli articoli del produttore <?php echo __('formatFilePdf');?>"><i class="fa fa-file-pdf-o fa-2x"></i></a></td>
		<td><a class="exportArticles" id="articlesSupplierOrganization-CSV" style="cursor:pointer;" rel="nofollow" title="stampa gli articoli del produttore <?php echo __('formatFileCsv');?>"><i class="fa fa-file-text-o fa-2x"></i></a></td>
		<td>
			<?php
			if(Configure::read('developer.mode'))
				echo 'No in developer mode';
			else
				echo '<a class="exportArticles" id="articlesSupplierOrganization-EXCEL" style="cursor:pointer;" rel="nofollow" title="stampa gli articoli del produttore '.__('formatFileExcel').'"><i class="fa fa-file-excel-o fa-2x"></i></a>';
			?>
		</td>
	</tr>
	...
	<tr>
		...
		<td><a class="exportArticlesOrders" id="articlesOrders-PDF" style="cursor:pointer;" rel="nofollow" title="stampa gli articoli dell'ordine <?php echo __('formatFilePdf');?>"><i class="fa fa-file-pdf-o fa-2x"></i></a></td>
		<td><a class="exportArticlesOrders" id="articlesOrders-CSV" style="cursor:pointer;" rel="nofollow" title="stampa gli articoli dell'ordine <?php echo __('formatFileCsv');?>"><i class="fa fa-file-text-o fa-2x"></i></a></td>
		<td>
			<?php
			if(Configure::read('developer.mode'))
				echo 'No in developer mode';
			else
				echo '<a class="exportArticlesOrders" id="articlesOrders-EXCEL" style="cursor:pointer;" rel="nofollow" title="stampa gli articoli dell\'ordine '.__('formatFilePdf').'"><i class="fa fa-file-excel-o fa-2x"></i></a>';
			?>
		</td>
	</tr>
	...
	<tr>
		...
		<td></td>
		<td><a class="suppliersOrganizations" id="suppliersOrganizations-PDF" style="cursor:pointer;" rel="nofollow" title="stampa i produttori <?php echo __('formatFilePdf');?>"><i class="fa fa-file-pdf-o fa-2x"></i></a></td>
		<td></td>
		<td>
			<?php
			if(Configure::read('developer.mode'))
				...
				echo '<a class="suppliersOrganizations" id="suppliersOrganizations-EXCEL" style="cursor:pointer;" rel="nofollow" title="stampa i produttori '.__('formatFilePdf').'"><i class="fa fa-file-excel-o fa-2x"></i></a>';
			?>
		</td>		
	</tr>		
	<tr>
		...
		<td></td>
		<td><a class="usersData" id="usersData-PDF" style="cursor:pointer;" rel="nofollow" title="stampa l'anagrafica degli utenti <?php echo __('formatFilePdf');?>"><i class="fa fa-file-pdf-o fa-2x"></i></a></td>
		<td><a class="usersData" id="usersData-CSV" style="cursor:pointer;" rel="nofollow" title="stampa l'anagrafica degli utenti <?php echo __('formatFileCsv');?>"><i class="fa fa-file-text-o fa-2x"></i></a></td>
		<td>
			<?php
			if(Configure::read('developer.mode'))
				echo 'No in developer mode';
			else
				echo '<a class="usersData" id="usersData-EXCEL" style="cursor:pointer;" rel="nofollow" title="stampa l\'anagrafica degli utenti '.__('formatFilePdf').'"><i class="fa fa-file-excel-o fa-2x"></i></a>';
			?>
		</td>		
	</tr>
	...
	<tr>
		...
		<td></td>
		<td><a class="referentsData" id="referentsData-PDF" style="cursor:pointer;" rel="nofollow" title="stampa dei referenti <?php echo __('formatFilePdf');?>"><i class="fa fa-file-pdf-o fa-2x"></i></a></td>
		<td><a class="referentsData" id="referentsData-CSV" style="cursor:pointer;" rel="nofollow" title="stampa dei referenti <?php echo __('formatFileCsv');?>"><i class="fa fa-file-text-o fa-2x"></i></a></td>
		<td>
			<?php
			if(Configure::read('developer.mode'))
				echo 'No in developer mode';
			else
				echo '<a class="referentsData" id="referentsData-EXCEL" style="cursor:pointer;" rel="nofollow" title="stampa dei referenti '.__('formatFilePdf').'"><i class="fa fa-file-excel-o fa-2x"></i></a>';
			?>
		</td>		
	</tr>
