 ...
 */
	function autoComplete($field, $url = [], $options = []) {
		...
		/*
		 $script = "{$var} jQuery('#{$htmlOptions['id']}').autocomplete({source:
					function (request, response) {
				        jQuery.ajax({
				            url: '".$this->url($url)."',
				            data: 'q='+jQuery('#{$htmlOptions['id']}').val(),
		 ...
		 */   
		$scriptNew =  $this->Javascript->codeBlock($script);
		$scriptNew = str_replace('&amp;','&',$scriptNew);
		return "{$text}\n" .$scriptNew;
 ...
 */
	function resizable($id, $options = array()) {
		...
		$script = "{$var} jQuery('#$id').resizable($options);";
		return $this->Javascript->codeBlock($script);
	}
/**
 ...
 */
	function selectable($id, $options = array()) {
		...
		$script = "{$var} jQuery('#$id').selectable($options);";
		return $this->Javascript->codeBlock($script);
	}
/**
 ...
 */
	function accordion($id, $options = array()) {
		...
		$script = "{$var} jQuery('#$id').accordion($options);";
		return $this->Javascript->codeBlock($script);
	}
/**
 ...
 */
	function button($id, $options = array()) {
		...
		$script = "{$var} jQuery('#$id').button($options);";
		return $this->Javascript->codeBlock($script);
	}
/**
 ...
 */
	function buttonset($id, $options = array()) {
		...
		$options = $this->_buildOptions($options, $this->buttonOptions);
		$script = "{$var} jQuery('#$id').buttonset($options);";
		return $this->Javascript->codeBlock($script);
	}
/**
 ...
 */
	function datepicker($id, $options = array()) {
		...
		$script = "{$var} jQuery('#$id').datepicker($options);";
		return $this->Javascript->codeBlock($script);
	}
/**
 ...
 */
	function dialog($id, $options = array()) {
		...
		$script = "{$var} jQuery('#$id').dialog($options);";
 ...
 */
	function progressbar($id, $options = array()) {
		...
		$script = "{$var} jQuery('#$id').progressbar($options);";
		return $this->Javascript->codeBlock($script);
	}
/**
 ...
 */
	function tabs($id, $options = array()) {
		...
		$script = "{$var} jQuery('#$id').tabs($options);";
		return $this->Javascript->codeBlock($script);
	}
/**
