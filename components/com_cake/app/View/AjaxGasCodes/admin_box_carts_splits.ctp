...
foreach($results as $numResult => $result) {
	...
	$tmp .= '	<input tabindex="'.$i.'" type="text" value="'.$result['CartsSplit']['importo_forzato_'].'" name="importo-'.$rowId2.'" id="importo-'.$rowId2.'" size="5" class="double importoSubmit" />&nbsp;<span>&euro;</span>';
	$tmp .= '</td>';
