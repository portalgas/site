...
<label class="control-label">Opzioni</label>
	...
	<div class="radio">
		<label><label class="radio-inline"><input type="radio" name="doc_options" id="to-users-all-modify" value="to-users-all-modify" /><?php echo __('to_users_all_modify');?></label>
	</div>
	<div class="radio">
		<label><label class="radio-inline"><input type="radio" name="doc_options" id="to-users" value="to-users" /><?php echo __('to_users');?></label>
	</div>
	<div class="radio">
		<label><label class="radio-inline"><input type="radio" name="doc_options" id="to-users-label" value="to-users-label" /><?php echo __('to_users_label');?></label>
	</div>
	<?php
	/*
	...
	if($isToValidate || $toQtaMassima || $toQtaMinimaOrder) { 
		echo '<div class="radio"><label><label class="radio-inline"><input type="radio" name="doc_options" id="to-articles-monitoring" value="to-articles-monitoring" />'.__('to_articles_monitoring').'</label></div>';
	}
	?>
	<div class="radio">
		<label><label class="radio-inline"><input type="radio" name="doc_options" id="to-articles" value="to-articles" /><?php echo __('to_articles');?></label>
	</div>
	<div class="radio">
		<label><label class="radio-inline"><input type="radio" name="doc_options" id="to-articles-details" value="to-articles-details" /><?php echo __('to_articles_details');?></label>
	</div>
	<div class="radio">
		<label><label class="radio-inline"><input type="radio" name="doc_options" id="to-articles-weight" value="to-articles-weight" /><?php echo __('to_articles_weight');?></label>
	</div>
</div>
<div class="col-sm-4">
		<?php
	...
	<div id="setting-to-articles-details" class="box-options">
		...
		<div class="doc-options">
			...
			<label class="radio-inline"><input type="radio" name="acquistato_il" id="acquistato_il_N" value="N" checked />No</label>
