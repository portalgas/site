...
foreach($desSupplierStates as $desSupplierState) {
	$htmlLegenda .= "\r\n";
	$htmlLegenda .= 'jQuery( ".desSupplierStato'.$desSupplierState['state_code'].'" ).mouseenter(function () {';
	$htmlLegenda .= "\r\n";
	...
	$htmlLegenda .= "\r\n";
	$htmlLegenda .= '	jQuery("#icoOrder'.$desSupplierState['state_code'].'").css("background-color","yellow").css("border-radius","15px 15px 15px 15px");';
	$htmlLegenda .= "\r\n";
	$htmlLegenda .= '	jQuery(".tdLegendaOrdersStateTesto").css("background-color","#F0F0F0");';
	$htmlLegenda .= "\r\n";
	$htmlLegenda .= '	jQuery("#testoOrder'.$desSupplierState['state_code'].'").show();';
	$htmlLegenda .= "\r\n";
	$htmlLegenda .= '});';

	$htmlLegenda .= "\r\n";
	$htmlLegenda .= 'jQuery( ".desSupplierStato'.$desSupplierState['state_code'].'" ).mouseleave(function () {';
	$htmlLegenda .= "\r\n";
