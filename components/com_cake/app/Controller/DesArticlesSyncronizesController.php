...
class DesArticlesSyncronizesController extends AppController {
	...
	public function admin_intro() { 
		...
		*/
		...
		/*
  		echo "<pre>ACLdesSuppliers \n ";
		print_r($ACLdesSuppliers);
		echo "</pre>";
		*/
	...
	public function admin_index($organization_id, $supplier_id) { 
		...
		/*
		echo "<pre>suppliersOrganizationResults \n";
		print_r($options['conditions']);
